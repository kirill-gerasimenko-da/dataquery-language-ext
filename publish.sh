...
dotnet pack ./src/DataQuery.LanguageExt/DataQuery.LanguageExt.csproj -c Release -o ./publish /p:PackageVersion=0.0.3

dotnet build ./src/DataQuery.LanguageExt.SourceGenerator/DataQuery.LanguageExt.SourceGenerator.csproj -c Release
dotnet pack ./src/DataQuery.LanguageExt.SourceGenerator/DataQuery.LanguageExt.SourceGenerator.csproj -c Release -o ./publish /p:PackageVersion=0.0.3
